...
Indexes created
---------------
On ``tabLive GEO Tracking`` (raw GPS table):
  idx_geo_emp_date   — (employee, device_date_time)   PRIMARY processing query
  idx_geo_date       — (device_date_time)              Scheduler DISTINCT employee query
...
_INDEXES = [
    # Raw GPS table
    (
        "tabLive GEO Tracking",
        "idx_geo_emp_date",
        ["employee", "device_date_time"],
    ),
    (
        "tabLive GEO Tracking",
        "idx_geo_date",
