...
# Fixtures
# --------
# Exported via: bench --site <site> export-fixtures --app frappe_ticktix
fixtures = [
    {
        "dt": "Custom Field",
        "filters": [
    ...
    },
    {
        ...
        "filters": [
            ["dt", "=", "Sales Order"],
            ["fieldname", "in", [
                "custom_customer_order_status",
                "custom_payment_gateway_message",
                "custom_payment_gateway_status",
                "custom_customer_employee",
                "custom_payment_gateway_order_id",
                "custom_payment_gateway_payment_id"
            ]]
        ]
    },
    {
        ...
        "filters": [
            ["dt", "=", "Contact"],
            ["fieldname", "in", [
                "custom_kyc_details_section",
                "custom_date_of_birth",
                "custom_pan",
                "custom_column_break_kyc",
    ...
    },
    {
        ...
        "filters": [
            ["dt", "=", "Customer"],
            ["fieldname", "in", [
                "custom_employment_tab",
                "custom_employment_type",
                "custom_column_break_employment_type",
                "custom_salaried_details_section",
                "custom_company_name",
                "custom_designation",
                "custom_total_work_experience",
                "custom_column_break_salaried",
                "custom_current_employer_experience",
                "custom_monthly_net_salary",
                "custom_salary_account_bank",
                "custom_self_employed_details_section",
                "custom_business_name",
                "custom_business_type",
                "custom_annual_turnover",
                "custom_column_break_self_employed",
                "custom_annual_income",
                "custom_years_in_business",
                "custom_gst_number",
                "custom_financial_tab",
                "custom_existing_emis",
                "custom_monthly_obligations",
                "custom_primary_bank",
                "custom_column_break_financial",
                "custom_credit_card_holder",
                "custom_number_of_credit_cards",
                "custom_existing_loan_types_section",
                "custom_existing_loan_type_personal_loan",
                "custom_existing_loan_type_home_loan",
                "custom_column_break_loan_types",
                "custom_existing_loan_type_vehicle_loan",
                "custom_existing_loan_type_business_loan",
                "custom_column_break_loan_types_2",
                "custom_existing_loan_type_gold_loan",
                "custom_loan_details_tab",
                "custom_loan_type",
                "custom_required_loan_amount",
                "custom_column_break_loan_details",
                "custom_preferred_tenure",
                "custom_loan_purpose"
            ]]
        ]
    },
...
app_include_js = "/assets/frappe_ticktix/js/ticktix_logout.js"
...
# Scheduler Events
# ----------------
# NOTE: Only ONE scheduler_events dict is allowed — the second definition
# below (lines ~251) has been merged here and removed to prevent silent override.
...
doc_events = {
	# Zitadel provisioning - push new users to Zitadel on creation, and again
	# if a user gains/changes an email later (e.g. Website Users created blank)
	"User": {
		"after_insert": "frappe_ticktix.plugins.authentication.zitadel_provisioner.auto_provision_user",
		"after_save": "frappe_ticktix.plugins.authentication.zitadel_provisioner.provision_on_email_update"
	},
...
# ---------------
scheduler_events = {
	# Runs once per day at the system-scheduler cadence (midnight)
	"daily": [
	...
	# Cron-based jobs for precise timing
	"cron": {
		# -----------------------------------------------------------------
		# Runs at 00:30 daily so we process the full previous day window
		# (00:00:00 to 23:59:59) after data for that day has settled.
		# then restart bench.
		# -----------------------------------------------------------------
		"30 0 * * *": [
			"frappe_ticktix.services.geo_processing.run_daily_travel_summary",
		],
	},
}
...
# Override /login to redirect to TickTix OAuth (Zitadel)
override_whitelisted_methods = {
...
# Daily Travel Summary API endpoints
override_whitelisted_methods["frappe_ticktix.api.geo_tracking.get_employee_travel_summary"] = "frappe_ticktix.api.geo_tracking.get_employee_travel_summary"
override_whitelisted_methods["frappe_ticktix.api.geo_tracking.get_team_travel_summary"] = "frappe_ticktix.api.geo_tracking.get_team_travel_summary"
override_whitelisted_methods["frappe_ticktix.api.geo_tracking.reprocess_travel_summary"] = "frappe_ticktix.api.geo_tracking.reprocess_travel_summary"
override_whitelisted_methods["frappe_ticktix.api.geo_tracking.trigger_batch_processing"] = "frappe_ticktix.api.geo_tracking.trigger_batch_processing"

# Payment Gateway API endpoints
override_whitelisted_methods["frappe_ticktix.api.v1.payments.create_order"] = "frappe_ticktix.api.v1.payments.create_order"
override_whitelisted_methods["frappe_ticktix.api.v1.payments.verify_payment"] = "frappe_ticktix.api.v1.payments.verify_payment"
