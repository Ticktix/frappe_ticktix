...
doc_events = {
	...
	"Employee Checkin": {
		...
		"before_insert": "frappe_ticktix.plugins.hr.checkin.checkin_manager.EmployeeCheckinOverride.before_insert",
		"after_insert": "frappe_ticktix.plugins.hr.checkin.checkin_manager.EmployeeCheckinOverride.after_insert"
	},
